...
template<class T>
class CProxy_IEngineEvents :
	public ATL::IConnectionPointImpl<T, &__uuidof(_IEngineEvents)>
{
public:
	HRESULT Fire_OnDataReady(BYTE * buf, int size)
	{
		HRESULT hr = S_OK;
		...
		for (int iConnection = 0; iConnection < cConnections; iConnection++)
		{
			...
			if (pConnection)
			{
				...
				avarParams[1].byref = buf;
				avarParams[1].vt = VT_UI1|VT_BYREF;
				avarParams[0] = size;
